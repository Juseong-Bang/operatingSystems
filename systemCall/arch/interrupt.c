...
#define SYSCALL_ARG_MAX 3
	...
	if(arg_num>0)
		arg[0]=(long) iframe->ebx;//arg0 in ebx
	if(arg_num>1)
		arg[1]=(long) iframe->ecx;//arg1 in ecx
	if(arg_num>2)
		arg[2]=(int*) iframe->edx;//arg2 in edx
	...
	*(pt) = ret;	//put return value into stack
}
