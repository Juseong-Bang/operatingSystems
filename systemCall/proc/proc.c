...
void login_prompt(void * aux)
{
	...
	while(1)	
	{
		printk("Welcome to OS Project #6!\n");
		shell_proc(NULL);
	}
}
...
void malloc_test(void * aux)
{
	void *ap1 = 0, *ap2 = 0, *ap3 = 0, *ap4 = 0, *ap5 = 0;
	// DO NOT TOUCH THIS FUNCTION!!!!

	printk("::First Allocation::\n");
	ap1 = malloc(256);
	printk("::Second Allocation::\n");
	ap2 = malloc(128);
	printk("::Third Allocation::\n");
	ap3 = malloc(104);
	printk("::Fourth Allocation::\n");
	free(ap2);
	ap4 = malloc(124);
	printk("::Fifth Allocation::\n");
	free(ap1);
	ap5 = malloc(356);
	free(ap3);
	free(ap4);
